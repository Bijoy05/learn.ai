...
import { Network, CheckCircle2, Circle, Lock } from "lucide-react";
...
export default function KnowledgeGraphPage() {
  ...
  return (
    <div className="flex h-full">
      {/* Left panel */}
      <motion.div
        className="w-[280px] shrink-0 border-r bg-card flex flex-col p-5 overflow-y-auto"
      ...
      >
        ...
        <p className="text-xs text-muted-foreground mb-6">
          Every skill you unlock expands this graph.
        </p>
        ...
        <div className="mb-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-foreground">You (center)</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-foreground">Skill / Topic</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-auto pt-4 border-t space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-xl bg-secondary p-3">
              <p className="text-lg font-bold text-foreground">{stats.unlocked}</p>
              <p className="text-[10px] text-muted-foreground">Skills Unlocked</p>
            </div>
            <div className="rounded-xl bg-secondary p-3">
            ...
            <div className="rounded-xl bg-secondary p-3 col-span-2">
              <p className="text-lg font-bold text-foreground">{stats.subjectsInProgress}</p>
              <p className="text-[10px] text-muted-foreground">Subjects In Progress</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <div className="flex-1 min-w-0 h-full">
        <KnowledgeGraph activeSubject={activeSubject} />
      </div>
    </div>
  );
}
